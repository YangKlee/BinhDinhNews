    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <div class="password-warper">
            ...
            <div class="input-icon-wrapper">
                <input type="password"  id="password" name="password_tb" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Mật khẩu có ít nhất 8 kí tự và có 1 kí tự đặt biệt và 1 chữ hoa và 1 chữ thường" required>
                <span class="icon-eye">
