...
CREATE TABLE IF NOT EXISTS `coquanchuyenmon` (
  ...
  `tencoquan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `donvisunghiep` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `chucvu` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `capbac` int DEFAULT NULL,
  `sunghiep` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `lanhdao` (
  ...
  `anh` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `capbac` int DEFAULT NULL,
  `donvi` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `ubnd` (
  ...
  `capbac` int NOT NULL,
  `diaphuong` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 'nbc', 'c880901c00eae55922076e756a5ad8c17beafa11f83edc9ed0988963e6e08643', NULL, NULL, 'nbc', NULL, NULL, NULL, NULL, NULL, '1')
